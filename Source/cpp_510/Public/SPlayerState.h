 ...
 */
UCLASS()
class CPP_510_API ASPlayerState : public APlayerState
{
	GENERATED_BODY()
...
protected:
	...
	// OnRep_ can use a parameter containing the 'old value' of the vatiable it is bound to. Very useful in this case to figure out the 'delta'
	UFUNCTION()
